...
export class Backend implements backendInterface {
    ...
    async getAllContactRequestsByEmail(): Promise<Array<ContactRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContactRequestsByEmail();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContactRequest(arg0: string): Promise<ContactRequest> {
        if (this.processError) {
            try {
    ...
    async submitContactRequest(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
